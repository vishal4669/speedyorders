    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-1 pull-right text-right">
                <a href="{{ route('admin.pages.create') }}" class="btn btn-primary-fade" data-toggle="tooltip" data-placement="top" data-original-title="Create Product">
                    <i class="fa fa-plus"></i>
                </a>
            </div>
            <div class="col-md-4 pull-right text-right">
                <form method="GET" action="{{ route('admin.pages.index') }}" accept-charset="UTF-8" role="search">
