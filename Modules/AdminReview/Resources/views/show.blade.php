                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Product Id </th><td> {{ $review->product_id }} </td></tr><tr><th> Customer Id </th><td> {{ $review->customer_id }} </td></tr><tr><th> Name </th><td> {{ $review->name }} </td></tr><tr><th> Review </th><td> {{ $review->review }} </td></tr>
                                </tbody>
                            </table>
                        </div>
