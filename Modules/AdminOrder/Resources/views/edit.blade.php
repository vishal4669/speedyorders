...
<div class="row">
    <div class="col-md-12">
        <div class="boxed">
            ...
            <div class="hpanel">
               <form method="POST" action="{{ route('admin.orders.update',[$order->id]) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        @include ('adminorder::form', ['formMode' => 'edit'])
                    </div>
                </form>
            </div>
        </div>
