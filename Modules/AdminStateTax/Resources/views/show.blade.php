                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Category Id </th><td> {{ $category->category_id }} </td></tr><tr><th> Name </th><td> {{ $category->name }} </td></tr><tr><th> Slug </th><td> {{ $category->slug }} </td></tr><tr><th> Image </th><td> {{ $category->image }} </td></tr>
                                </tbody>
                            </table>
                        </div>
