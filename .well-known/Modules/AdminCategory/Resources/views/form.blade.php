...
<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" type="text" name="name" id="name" value="{{ isset($category->name) ? $category->name : ''}}" > </input>

    {!! $errors->first('name', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('slug') ? 'has-error' : ''}}">
    <label for="slug" class="control-label">{{ 'Slug' }}</label>
    <input class="form-control" type="text" name="slug" id="slug" value="{{ isset($category->slug) ? $category->slug : ''}}" > </input>
