                               ...
                               <table class="table table-bordered">
                                  ...
                                  <tbody>
                                     <tr>
                                        ...
                                        <td>
                                           <address>
                                              {{ $order->shipping_first_name.' '.$order->shipping_last_name }}<br />{{ $order->shipping_company }}<br />{{ $order->shipping_address_1 }} <br/> {{ $order->shipping_address_2 }} <br/> {{ $order->shipping_postcode }} <br /> {{ $order->shipping_state }} <br/>  <br />{{ $order->shippingCountry->name }}
                                           </address>
                                        </td>
                                     </tr>
                                  </tbody>
