   ...
   <div class="row">
       <div class="panel panel-default">
           ...
           <div class="panel-body">
               <form action="{{ route('users.store') }}" method="POST" class="form-horizontal form-padding" enctype="multipart/form-data">
                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
                       <div class="form-group">
                           <label class="col-md-2 control-label" for="admin-first-name">Full Name <span class="text-danger">*</span></label>
                           <div class="col-md-5">
                               <input type="text" id="admin-first-name" name="first_name" class="form-control" value="{{ old('first_name') }}" placeholder="First Name" >
                               <small class="help-block text-danger">{{$errors->first('first_name')}}</small>
                           </div>
                           <div class="col-md-4">
                               <input type="text" id="admin-last-name" name="last_name" class="form-control" value="{{ old('last_name') }}" placeholder="Last Name" >
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-md-9">
                               <div class="checkbox">
                                   @if( count($groups) > 0 )
                                       @foreach($groups as $g)
                                           <input id="group-{{$g->id}}" class="i-checks" type="checkbox" name="groups[]" value="{{ $g->id }}" {{ old("groups[]") == $g->id ? "checked" : '' }}>
