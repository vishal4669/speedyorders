            ...
            <input type="hidden" name="id" @if(isset($banner)) value="{{ $banner->id }}" @endif>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="radio" id="first" name="active" value="1" {{ old('active', isset($banner)&&$banner->active=='1' ? 'checked' : '') }} >
                                <label for="first">First</label><br>
                                <input type="radio" id="second" name="active" value="2" {{ old('active', isset($banner)&&$banner->active=='2' ? 'checked' : '') }} >
                                <label for="second">Second</label><br>
                                <input type="radio" id="third" name="active" value="3" {{ old('active', isset($banner)&&$banner->active=='3' ? 'checked' : '') }} >
