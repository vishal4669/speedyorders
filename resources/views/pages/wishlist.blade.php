    ...
    <div class="row">
        ...
        <div class="col-md-3 order-1 account-side-info-wrapper">
            ...
            <div class="mt-md-5 account-side-info">
                <img src="frontend_assets/img/profile-img.jpg" alt="Name" class="rounded mb-3 account-side-img">
                ...
                <div class="d-flex align-items-center flex-wrap mb-4 last-purchase-img">
                    <a href="#" class="img"><img src="frontend_assets/img/base_layout/prod-img.jpg" alt="Name" class="w-100 rounded"></a>
                    <a href="#" class="img"><img src="frontend_assets/img/base_layout/prod-img.jpg" alt="Name" class="w-100 rounded"></a>
                    <a href="#" class="img"><img src="frontend_assets/img/base_layout/prod-img.jpg" alt="Name" class="w-100 rounded"></a>
