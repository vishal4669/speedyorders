...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'id','uuid','sku','name','description','base_price','length','breadth','height','width','quantity','min_quantity','subtract_stock','sort_order','status', 'available','meta_title','meta_description','return_policy_days','category_id','image','video','trending','is_featured',
    ];
