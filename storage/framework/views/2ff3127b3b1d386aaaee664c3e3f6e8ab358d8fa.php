            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="first_name" value="<?php echo e(old('first_name', isset($customer) ? $customer->first_name : null)); ?>"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="last_name" value="<?php echo e(old('last_name', isset($customer) ? $customer->last_name : null)); ?>"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="email" value="<?php echo e(old('email', isset($customer) ? $customer->email : null)); ?>"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="telephone" value="<?php echo e(old('telephone', isset($customer) ? $customer->telephone : null)); ?>"
                        class="form-control">
                </div>
            </div>
        ...
        <div id="tab-2" class="tab-pane">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">First Name</label>
                <div class="col-md-4">
                    <input type="text" name="c_first_name" value="<?php echo e(old('c_first_name')); ?>"
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">Last Name</label>
                <div class="col-md-4">
                    <input type="text" name="c_last_name" value="<?php echo e(old('c_last_name')); ?>"
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">Phone</label>
                <div class="col-md-4">
                    <input type="text" name="c_telephone" value="<?php echo e(old('c_telephone')); ?>"
            ...
            <div class="form-group">
                ...
                <table id="option-values-table"
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $customer->addresses ??[]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr id style='display: table-row;' class='footable-even'>
                            <td class='footable-visible footable-first-column'>
                                <?php echo e($item->c_first_name.' '.$item->c_last_name); ?>
                            ...
                            <td class='footable-visible footable-last-column'>
                                ...
                                <button type='button' class='btn btn-danger edit-address-btn' data-edit-url="<?php echo e(route('admin.customers.address.details',$item->id)); ?>"><i class="fas fa-edit"></i></button>
                            </td>
                        </tr>
        ...
        <div id="tab-3" class="tab-pane">
            ...
            <div class="form-group">
                ...
                <table id="option-values-table"
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $customer->transactions ??[]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr id style='display: table-row;' class='footable-even'>
                            <td class='footable-visible footable-first-column'>
        ...
        <div id="tab-4" class="tab-pane">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="text" name="total_accounts" value="<?php echo e(old('total_accounts')); ?>"
            ...
            <?php if(isset($customer->ipAddresses)): ?>
            <div class="form-group">
                <h4>Ips</h4>
                <table id="option-values-table"
                    class="footable table table-stripped table-bordered toggle-arrow-tiny default breakpoint footable-loaded"
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $customer->ipAddresses ??[]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr id style='display: table-row;' class='footable-even'>
                            <td class='footable-visible footable-first-column'>
                                <?php echo e($item->ip); ?>
...
<?php /**PATH /var/www/html/speedyorder/Modules/AdminCustomer/Resources/views/form.blade.php ENDPATH**/ ?>