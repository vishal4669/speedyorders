...
<!-- <section class="container mb-5">
        ...
        <div data-gridify="3-columns">
            ...
            <?php $__currentLoopData = $homepage_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                    <a href="<?php echo e(route('product-listings', ['category_slug' => $category->slug])); ?>" title="" class="grid-img-menu-item card border-0">
                        <img src="<?php echo e((isset($category->image) && $category->image!='') ? url('images/categories/'.$category->image) : 'https://via.placeholder.com/545x500'); ?>" class="w-100 rounded">
                        <div class="info info-floating pt-2 text-center d-flex flex-column align-items-center justify-content-center w-100 rounded">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/speedyorders/public_html/modban.com/resources/views/categories.blade.php ENDPATH**/ ?>