    ...
    <div id="logo" class="light-version">
        <a href="<?php echo e(route('home')); ?>">
            <span title="Speedy Orders">
                <img src="<?php echo e(url('images/'.Option::get('site_logo'))); ?>" class="m-b" alt="logo" style="width: 100%; max-height: 52px;">
            </span>
        </a>
    </div>
...
<?php /**PATH /home/speedyorders/public_html/modban.com/resources/views/commons/header.blade.php ENDPATH**/ ?>