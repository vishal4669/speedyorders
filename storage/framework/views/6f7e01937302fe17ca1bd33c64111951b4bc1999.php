        ...
        <div class="row">
            <div class="col-md-3 col-xl-2 filters-wrapper">
                ...
                <div class="filters-list">
                            ...
                            <?php if(!empty($categories_list)): ?>
                                    ...
                                    <?php $__currentLoopData = $categories_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                 
                                        <li class="has-sub-category">
                                                ...
                                                <?php if(isset($filter_category_id) && $filter_category_id==$category->id): ?>
                                                    <a style="clear:both" href="<?php echo e(route('store', ['category_slug' => $category->slug])); ?>" title="<?php echo e($category->name); ?>" class="filter-option-link"><b><?php echo (strlen($category->name) > 30) ? substr($category->name,0,30).'...' : $category->name; ?></b></a>
                                                <?php else: ?>
                                                    <a style="clear:both"  href="<?php echo e(route('store', ['category_slug' => $category->slug])); ?>" title="<?php echo e($category->name); ?>" class="filter-option-link"><?php echo (strlen($category->name) > 30) ? substr($category->name,0,30).'...' : $category->name; ?></a>
                                                <?php endif; ?>

                                                <!-- <?php echo e(route('store', ['category_slug' => $category->slug])); ?> -->

                                                <ul style="display:none">
                                                    
                                                    <?php if(!empty($category->categories)): ?>
                                                        <?php $__currentLoopData = $category->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                            <?php if(isset($filter_category_id) && $filter_category_id==$child_category->id): ?>
                                                                <li class="filter-option-link" style="list-style:none;">&nbsp;&nbsp;&nbsp;<a href="<?php echo e(route('store', ['category_slug' => $child_category->slug])); ?>" title="<?php echo e($child_category->name); ?>" ><b><?php echo (strlen($child_category->name) > 30) ? substr($child_category->name,0,30).'...' : $child_category->name; ?></b></a>
                                                                    </li>
                                                                
                                                            <?php else: ?>
                                                                <li class="filter-option-link" style="list-style:none;">&nbsp;&nbsp;&nbsp;<a href="<?php echo e(route('store', ['category_slug' => $child_category->slug])); ?>" title="<?php echo e($child_category->name); ?>" ><?php echo (strlen($child_category->name) > 30) ? substr($child_category->name,0,30).'...' : $child_category->name; ?></a>
                                                                </li>
                                                            <?php endif; ?>    
                    ...
                    <a href="<?php echo e(route('store')); ?>" title="" class="btn btn-small btn-outline-secondary w-100 mt-3">Clean Filters</a>
                </div>
            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 pr-md-5">
                                ...
                                <div class="d-flex prod-list-actions">
                                    <a href="<?php echo e(route('cart')); ?>" title="Add to cart" class="btn btn-add-cart"><i class="icon-cart d-md-none"></i><span class="d-none d-md-block">ADD TO CART</span></a>
                                    <a href="<?php echo e(route('wishlist')); ?>" title="Add to wishlist" class="btn btn-add-wishlist"><i class="icon-wishlist"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/speedyorders/public_html/modban.com/resources/views/store/index.blade.php ENDPATH**/ ?>