...
<head>
    ...
    <meta name="_token" content="<?php echo e(csrf_token()); ?>" charset="utf-8">
    <title><?php echo e(config('app.name', 'Speedy Orders')); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e(url('frontend_assets/img/favicon-32x32.png')); ?>" sizes="32x32" />
    <link rel="icon" type="image/png" href="<?php echo e(url('frontend_assets/img/favicon-16x16.png')); ?>" sizes="16x16" />
    <link rel="icon" type="image/x-icon" href="<?php echo e(url('frontend_assets/img/favicon.ico')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style.css?ver-64665')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_icons.css?ver-656646565')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_header.css?ver-3434434')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_footer.css?ver-656766776')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_blocks_layout.css?ver-322434')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_template_pages.css?ver-4565676776')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_product.css?ver-6767767676')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_cart_checkout.css?ver-324356677')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('frontend_assets/css/style_account.css?ver-8787')); ?>" />
...
<body>
   ...
   ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-auto col-md-4 col-lg-3 mr-auto d-flex align-items-center">
                    ...
                    <a href="<?php echo e(url('/')); ?>" title="Homepage" class="d-lg-block mx-lg-auto ml-xl-0"><img srcset="<?php echo e(url('frontend_assets/img/logo@2x.png 2x')); ?>" src="<?php echo e(url('images/'.Option::get('site_logo'))); ?>" width="245" class="header-logo" alt="Speedy Orders"></a>
                </div>
                <div class="col-auto order-md-3 d-lg-none">
                    <a href="<?php echo e(route('wishlist')); ?>" title="Orders" class="header-item header-item-wishlist"><i class="icon-wishlist"></i>
                        <div class="qtd">10</div>
                    </a>
                    <a href="<?php echo e(route('cart')); ?>" title="Cart" class="header-item header-item-cart"><i class="icon-cart"></i>
                        <div class="qtd cart_items_count_header"><?php echo e(($cart_counts > 0) ? $cart_counts : ''); ?></div>
                    </a>
                </div>
                    ...
                    <form class="d-flex header-search-form">
                        <div class="dropdown search-filter-dropdown">
                            ...
                            <div class="dropdown-menu custom-scroll" aria-labelledby="searchFilterBtn">
                                ...
                                <?php $__currentLoopData = $homepage_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a onclick="selectCategory('<?php echo e($category->id); ?>')" href="#" data-id="<?php echo e($category->id); ?>" title="filter"><?php echo e($category->name); ?></a>
                ...
                <div class="d-none d-lg-flex align-items-center justify-content-end col-lg-3">
                    ...
                    <a href="<?php echo e(route('register')); ?>" title="Register" class="header-item header-item-register"><i class="fa fa-id-badge"></i><span class="header-item-text">Register</span></a>
                    <a href="<?php echo e(route('login')); ?>" title="Login" class="header-item header-item-login"><i class="fa fa-user"></i><span class="header-item-text">Login</span></a>
                </div>
            </div>
        </div>
        <div class="header-bottom-bar">
            <div class="container d-lg-flex align-items-center">
                ...
                <ul class="d-lg-flex flex-lg-wrap align-items-lg-center justify-content-xl-center px-0 col-lg offset-xl-2 main-menu-wrapper">
                    <li><a href="<?php echo e(route('store')); ?>" title="Store" class="<?= ($activePage == 'store') ? 'active' : ''; ?>">Store</a></li>
                    <li><a href="<?php echo e(route('promotions')); ?>" title="Promotions" class="<?= ($activePage == 'promotions') ? 'active' : ''; ?>">Promotions</a></li>
                    <li><a href="<?php echo e(route('trendings')); ?>" title="Trending" class="<?= ($activePage == 'trendings') ? 'active' : ''; ?>">Trending</a></li>
                    <li><a href="<?php echo e(route('categories')); ?>" title="Categories" class="<?= ($activePage == 'categories') ? 'active' : ''; ?>">Categories</a></li>
                    <li><a href="<?php echo e(route('b2b_home')); ?>" title="Business" class="<?= ($activePage == 'b2b_home') ? 'active' : ''; ?>">Business</a></li>
                    <li><a href="<?php echo e(route('support')); ?>" title="Support" class="<?= ($activePage == 'support') ? 'active' : ''; ?>">Support</a></li>
                </ul>
                ...
                <a href="<?php echo e(route('wishlist')); ?>" title="Orders" class="header-item header-item-wishlist d-none d-lg-flex"><i class="icon-wishlist"></i>
                    <div class="qtd">10</div>
                </a>
                <a href="<?php echo e(route('cart')); ?>" title="Cart" class="header-item header-item-cart d-none d-lg-flex"><i class="icon-cart"></i>
                    <div class="qtd cart_items_count_header"><?php echo e(($cart_counts > 0) ? $cart_counts : ''); ?></div>
                </a>
    ...
    <main role="main">
        ...
        <?php if($activePage && $activePage!='store' && $activePage!='login' && $activePage!='register' && $activePage!='support' && $activePage!='Pin List'&& $activePage!='Cart' && $activePage!='Delivery' && $activePage!='home' && $activePage!='promotions' && $activePage!='b2b_home'): ?>
            <?php if(!$url): ?>
                <section class="intro-block block-fade-out-bottom block-negative-bottom">
                    <div class="intro-block-slider">
                        <div class="slider-item">
                            ...
                            <picture>
                                <source media="(max-width: 767px)" srcset="<?php echo e(url('frontend_assets/img/base_layout/m-home-intro.jpg')); ?>">
                                <img src="<?php echo e(url('frontend_assets/img/base_layout/home-intro-alt.jpg')); ?>" alt="Discover our new collection of wedding signs">
                            </picture>
                        </div>
                        <div class="slider-item">
                            <div class="d-flex justify-content-end justify-content-md-center flex-column info">
                            ...
                            <picture>
                                <source media="(max-width: 767px)" srcset="<?php echo e(url('frontend_assets/img/base_layout/m-home-intro-2.jpg')); ?>">
                                <img src="<?php echo e(url('frontend_assets/img/base_layout/home-intro-alt.jpg')); ?>" alt="Discover our new collection of wedding signs">
                            </picture>
                        </div>
                    </div>
...
<a href="<?php echo e(route('support')); ?>" title="Support" class="btn-footer-chat"><i class="icon-chat mr-2"></i>Support</a>
...
<div class="bg-red support-cta-wrapper">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <!-- support opens chat -->
            <a href="<?php echo e(route('support')); ?>" title="click for support" class="btn btn-outline-light btn-small"><b>Click Here For Support</b></a>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-6 col-md-3 col-lg-2 footer-menu-block">
                ...
                <ul class="footer-menu">
                    <li><a href="<?php echo e(url('/pages/about-so')); ?>" title="About SO">About SO</a></li>
                    <li><a href="<?php echo e(url('/pages/careers')); ?>" title="Careers">Careers</a></li>
                    <li><a href="<?php echo e(url('/pages/blog')); ?>" title="Blog">Blog</a></li>
                    <li><a href="<?php echo e(url('/pages/news')); ?>" title="News">News</a></li>
                    <li><a href="<?php echo e(url('/pages/our-service-promise')); ?>" title="Our Service Promise">Our Service Promise</a></li>
                    <li><a href="<?php echo e(url('/pages/investor-centers')); ?>" title="Investor Centre">Investor Centre</a></li>
                    <li><a href="<?php echo e(url('/pages/delivery-gurantees')); ?>" title="Delivery Guarantees">Delivery Guarantees</a></li>
                    <li><a href="<?php echo e(url('/pages/acreylic-cleaning')); ?>" title="Acrylic Cleaning">Acrylic Cleaning</a></li>
                </ul>
                <img srcset="frontend_assets/img/logo-white-small@2x.png 2x" src="<?php echo e(url('frontend_assets/img/logo-white-small.png')); ?>" width="56" class="footer-logo d-none d-lg-block" alt="Speedy Orders">
            </div>
            <div class="col-6 col-md-3 col-lg-2 footer-menu-block">
                ...
                <ul class="footer-menu">
                    ...
                    <li><a href="<?php echo e(url('/pages/contact-us')); ?>" title="Contact Us">Contact Us</a></li>
                    <li><a href="<?php echo e(url('/pages/return-policy')); ?>" title="Returns Policy">Returns Policy</a></li>
                    <li><a href="<?php echo e(route('site_map')); ?>" title="Site Map">Site Map</a></li>
                </ul>
            </div>
            <div class="col-6 col-md-3 col-lg-2 footer-menu-block">
                <div class="footer-menu-title">Legal</div>
                <ul class="footer-menu">
                    <li><a href="<?php echo e(url('/pages/terms-and-conditions')); ?>" title="Terms & Conditions">Terms & Conditions</a></li>
                    <li><a href="<?php echo e(url('/pages/cookies-policy')); ?>" title="SO’s Cookies Policy">SO’s Cookies Policy</a></li>
                    <li><a href="<?php echo e(url('/pages/privacy-policy')); ?>" title="Privacy Policy">Privacy Policy</a></li>
                    <li><a href="<?php echo e(route('faq')); ?>" title="FAQ">FAQ</a></li>
                </ul>
            </div>
            <div class="col-6 col-md-3 col-lg-2 footer-menu-block">
                ...
                <ul class="footer-menu">
                    ...
                    <li><a href="<?php echo e(route('cart')); ?>" title="Cart">Cart</a></li>
                    <li><a href="#" title="Register">Register</a></li>
                    <li><a href="<?php echo e(route('wishlist')); ?>" title="Wishlist">Wishlist</a></li>
            ...
            <div class="col-lg-2 d-flex flex-wrap justify-content-md-end align-items-start align-content-start">
                <img srcset="<?php echo e(url('frontend_assets/img/logo-white-small@2x.png 2x')); ?>" src="<?php echo e(url('frontend_assets/img/logo-white-small.png')); ?>" width="56" class="footer-logo d-lg-none mr-auto" alt="Speedy Orders">
...
<script src="<?php echo e(url('frontend_assets/js/geral.js?ver-545454545')); ?>" type='text/javascript'></script>
<script src="<?php echo e(url('frontend_assets/js/gridify.min.js')); ?>" type='text/javascript'></script>
<script src="<?php echo e(url('frontend_assets/js/store.js')); ?>" type='text/javascript'></script>
<script>
    $(document).ready(function(){
    	$("#search-box").keyup(function(){
    		...
    		$.ajax({
        		type: "POST",
        		url: "<?php echo e(route('search_products')); ?>",
    ...
    function showProductDetails(){
        ...
        if(productId && productId!=''){
            ...
            window.location.href = "<?php echo e(url('/product-details/')); ?>/"+productSlug;
        } else {
            window.location.href = "<?php echo e(route('store')); ?>";
        }
...
</html><?php /**PATH /home/speedyorders/public_html/modban.com/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>