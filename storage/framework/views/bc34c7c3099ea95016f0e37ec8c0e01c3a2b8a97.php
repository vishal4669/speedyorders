                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif($item->status == 2): ?>
                                    <a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Process Payment" href="<?php echo e(route('admin.orders.stripe', $item->id  )); ?>">
                                        <i class="fa fa-tasks"></i>
                                    </a>
                                <?php endif; ?>
