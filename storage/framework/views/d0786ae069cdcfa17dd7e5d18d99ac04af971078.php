...
<div class="panel-heading">
    <div class="row">
        <div class="col-md-3">
            <h5><strong><?php echo e($action ?? null); ?> Product</strong> </h5>
        </div>
...
<div class="panel-body">
    ...
    <div class="tab-content">
        ...
        <div id="tab-5" class="tab-pane">
            <?php echo $__env->make('adminproduct::forms.shipping_zone', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

</div>

<?php /**PATH /var/www/html/speedyorder/Modules/AdminProduct/Resources/views/form.blade.php ENDPATH**/ ?>