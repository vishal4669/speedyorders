...
<div class="form-group <?php echo e($errors->has('return_policy') ? 'has-error' : ''); ?>">
    <label for="return_policy" class="control-label"><?php echo e('Return Policy'); ?></label>
...
<?php /**PATH /var/www/html/speedyorders/Modules/AdminCategory/Resources/views/form.blade.php ENDPATH**/ ?>