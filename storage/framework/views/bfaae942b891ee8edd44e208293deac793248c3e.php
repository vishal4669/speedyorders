        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-product-package-panel">
                    <label for="order_product_package" class="control-label"><?php echo e('Package *'); ?></label>
...
</div><?php /**PATH /var/www/html/speedyorder/Modules/AdminOrder/Resources/views/formelements/add-product-modal.blade.php ENDPATH**/ ?>