    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-1 pull-right text-right">
                 <a href="<?php echo e(route('admin.categories.import')); ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" data-original-title="Import">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($item->image && $item->image!=''): ?>
                                    <image height="50px" width="50px" src="<?php echo e(url('/images/categories/'.$item->image)); ?>"></image>
                                <?php endif; ?>
                            </td>
                            <td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/speedyorders/public_html/modban.com/Modules/AdminCategory/Resources/views/index.blade.php ENDPATH**/ ?>