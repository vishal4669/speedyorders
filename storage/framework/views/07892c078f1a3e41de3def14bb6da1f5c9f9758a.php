...
<div class="form-group <?php echo e($errors->has('shipping_country_name') ? 'has-error' : ''); ?>">
    <label for="shipping_country_name" class="control-label"><?php echo e('Country Name *'); ?></label>
...
</div><?php /**PATH /var/www/html/speedyorder/Modules/AdminOrder/Resources/views/formelements/shippment.blade.php ENDPATH**/ ?>