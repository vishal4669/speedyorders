...
<div class="form-group <?php echo e($errors->has('payment_country_name') ? 'has-error' : ''); ?> payment_fields">
    <label for="payment_country_name" class="control-label"><?php echo e(' Country '); ?></label>
...
</div><?php /**PATH /home/speedyorders/public_html/modban.com/Modules/AdminOrder/Resources/views/formelements/payment.blade.php ENDPATH**/ ?>